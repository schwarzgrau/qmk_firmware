 ...
 *   3 B3 04 LED
 */
inline void aplus_01_led_on(void)       { DDRD |= (1 << 1); PORTD &= ~(1 << 1); }
inline void aplus_02_led_on(void)       { DDRD |= (1 << 0); PORTD &= ~(1 << 0); }
inline void aplus_03_led_on(void)       { DDRB |= (1 << 7); PORTB &= ~(1 << 7); }
inline void aplus_04_led_on(void)       { DDRB |= (1 << 3); PORTB &= ~(1 << 3); }

inline void aplus_01_led_off(void)      { DDRD &= ~(1 << 1); PORTD &= ~(1 << 1); }
inline void aplus_02_led_off(void)      { DDRD &= ~(1 << 0); PORTD &= ~(1 << 0); }
inline void aplus_03_led_off(void)      { DDRB &= ~(1 << 7); PORTB &= ~(1 << 7); }
inline void aplus_04_led_off(void)      { DDRB &= ~(1 << 3); PORTB &= ~(1 << 3); }
